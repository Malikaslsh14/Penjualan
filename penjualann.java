 ...
 * @author acer
 */
public class penjualann extends javax.swing.JFrame {
    int reguler,gold,ultra,harga,beli,total,bayar,kembali;
    
    /**
     * Creates new form penjualann
     */
    public penjualann() {
        initComponents();
    }
    ...
    private void btn_printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_printActionPerformed
        ...
        "Total Pembayaran :"+txt_pembayaran.getText()+"\n"+
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(penjualann.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new penjualann().setVisible(true);
            }
        });
    }
